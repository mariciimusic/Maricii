...
const Model = ({state , details , toggleModel}) => {
    return state ? (
        ...
        <MdClose onClick={toggleModel} className="cursor-pointer text-[25px] absolute top-6 right-6 text-black dark:text-white"/>

        <div className="max-w-screen-lg w-full bg-white dark:bg-zinc-900 p-6 rounded-lg border border-zinc-100 dark:border-zinc-700 max-h-[80vh] overflow-x-auto">
